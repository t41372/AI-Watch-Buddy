...
export function WebSocketHandler({ children }: WebSocketHandlerProps) {
  // WebSocket 连接状态
  ...
  const connect = useCallback((sessionId: string) => {
    const wsUrl = `${generalSettings.websocketBaseUrl}/${sessionId}`;
  ...
  }, [generalSettings.websocketBaseUrl, handleMessage]);
